...
dVr_r_time = zeros (Nti*Nri,nFrames);
VortRelat_time = zeros (Nti*Nri,nFrames);
VortPot_time = zeros (Nti*Nri,nFrames);
VortPot_zm_time = zeros (Nri,nFrames);
%
iit=0;
% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%                                                                                              TIME LOOP:
...
fileout2 = [roots,'/dVz_dr_time_',num2str(Nti),'_',num2str(Nri),'_',num2str(nFrames)];
...
fileout3 = [roots,'/dVr_dphi_time_',num2str(Nti),'_',num2str(Nri),'_',num2str(nFrames)];
...
fileout4 = [roots,'/VortPot_time_',num2str(Nti),'_',num2str(Nri),'_',num2str(nFrames)];
...
fileout5 = [roots,'/VortRelat_time_',num2str(Nti),'_',num2str(Nri),'_',num2str(nFrames)];
...
fileout6 = [roots,'/VortPot_zm_time_',num2str(Nti),'_',num2str(Nri),'_',num2str(nFrames)];
